...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {[_QWERTY] = LAYOUT_split_3x6_3(
    ...
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_LCMD, LOWER,   KC_SPC,     KC_ENT,  RAISE,   KC_RALT
                                        //`--------------------------'  `--------------------------'
...
[_RAISE] = LAYOUT_split_3x6_3(
    //,-----------------------------------------------------.                    ,-----------------------------------------------------.
       KC_BSLS, KC_LBRC, KC_RBRC, KC_EXLM, KC_AMPR, KC_PIPE,                      KC_AT,   KC_EQL,  KC_PLUS, KC_ASTR, KC_PERC, KC_BSPC,
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       KC_HASH, KC_LPRN, KC_RPRN, KC_DQT,  KC_QUOT, KC_TILD,                      KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT, KC_QUOT, KC_TAB, 
    //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
       KC_LSFT, KC_LCBR, KC_RCBR, KC_GRV,  KC_CIRC, KC_DLR,                       XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_RSFT, 
    //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+--------+--------+--------|
                                           KC_LCMD, LOWER,   KC_SPC,     KC_ENT,  RAISE,   KC_RALT
                                        //`--------------------------'  `--------------------------'
    ),
